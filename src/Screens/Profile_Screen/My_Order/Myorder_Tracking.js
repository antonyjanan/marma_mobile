            ...
            <ScrollView style={styles.content}>
                ...
                <View style={styles.orderItemCard}>
                    ...
                    <View style={styles.orderDetails}>
                        ...
                        <Text style={styles.priceText}>₹ 1400
                ...
                <View style={styles.paymentInfoCard}>
                    <View style={styles.paymentHeaderRow}>
                        ...
                        <View>
                            ...
                            <Text style={styles.dateTimeText}>Date: 12 feb 2025 {"\n"}03:59 pm</Text>
                        </View>
                    </View>
                ...
                <View style={styles.deliverySection}>
                    ...
                    <View style={styles.addressRow}>
                        <View style={styles.addressContainer}>
                            ...
                            <Text style={styles.contactText}>Mobile Number +91 7826 59810</Text>
                        </View>
                        <View style={styles.changeButtonss}>
                            ...
                            <Text style={styles.updateAddressText}>Update your address before your order is packed</Text>
