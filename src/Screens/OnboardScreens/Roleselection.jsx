  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.mainHeading}>Pick who you want to be.</Text>

        <Text style={styles.subtitle}>
          Blend of Modern Reflexology with the Traditional{'\n'}Chakra Healing
        </Text>

        {/* First Card - Book a therapist */}
        <View style={styles.card}>
          <Image
            source={require('../../assets/images/marmasset/relaxfoot1.png')}
            style={styles.cardImage}
          />
        </View>

        <TouchableOpacity style={styles.redButton} onPress={handleBecomeUser}>
          <Text style={styles.buttonText}>Click here</Text>
        </TouchableOpacity>
        <View style={{marginLeft: 10}}>
          <Text style={styles.jobHeading}>Searching for a job?</Text>
        ...
        <View style={styles.card}>
          <Image
            source={require('../../assets/images/marmasset/relaxfoot2.png')}
            style={styles.cardImage}
          />
        </View>
