  ...
  return (
    ...
    <LinearGradient
      ...
      <View style={styles.textcontent}>
        <Text style={styles.mainTitle}>CP's Reflex Marma Therapy</Text>

        <Text style={styles.subtitle}>
          Blend of Modern Reflexology with the{'\n'}Traditional Chakra Healing
        </Text>

        <Text style={styles.description}>
          Say good bye to stressful workout{'\n'}exercises...
        </Text>
