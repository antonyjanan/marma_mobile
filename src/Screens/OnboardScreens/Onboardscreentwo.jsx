...
const Onboardscreentwo = () => {
   ...
   const navigation = useNavigation();
    ...
    const Nextscreen = () => {
      navigation.navigate('Onboardscreenthree');
    };
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      <ImageBackground
        source={require('../../assets/images/marmasset/onboardiingbg.png')}
        style={styles.profileBackground}
        resizeMode="cover">
        {/* <LinearGradient
        colors={['rgba(254, 0, 0, 0)', '#FE0000']}
        start={{x: 0.5, y: 0.4}}
        end={{x: 0.5, y: 3.4}}
        ...
        <View style={styles.textcontent}>
          <View style={{marginBottom: 40}}>
            ...
            <Text style={styles.subtitle}>
              Stress Reduction{'\n'}
              <Text style={styles.subtitleHighlight}>Improved Circulation</Text>
            </Text>

            <Text style={styles.subtitleHighlight}>
              Enhanced Relaxation{' '}
              <Text style={styles.subtitle}> Pain {'\n'}</Text>
              <Text style={styles.subtitle}>Reduction</Text>
            </Text>
          </View>
