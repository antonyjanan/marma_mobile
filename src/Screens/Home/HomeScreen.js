...
const banners = [
  {
    ...
    description: 'Claim your discount 30% daily now!',
    image: require('../../assets/images/Fishimage/fishhead.png'),
...
const categories = [
  { name: "Fish", icon: require("../../assets/images/Fishimage/splashimage.png") },
  { name: "Fruits", icon: require("../../assets/images/Fishimage/splashimage.png") },
  { name: "Vegetables", icon: require("../../assets/images/Fishimage/splashimage.png") },
  { name: "Milk", icon: require("../../assets/images/Fishimage/splashimage.png") },
  { name: "Biscuit", icon: require("../../assets/images/Fishimage/splashimage.png") },
  { name: "Juice", icon: require("../../assets/images/Fishimage/splashimage.png") },
  { name: "Meat", icon: require("../../assets/images/Fishimage/splashimage.png") },
];
const HomeScreen = () => {
      ...
      >
        ...
        <View style={styles.headerContainer}>
          ...
          <View style={styles.headerIcons}>
            ...
            <TouchableOpacity style={styles.newStyle} onPress={() => navigation.navigate('Notification')}>
              <Image
        ...
        <View style={styles.searchContainer}>
          <View style={styles.insideseach}>
            ...
            <TouchableOpacity style={styles.filterIcon} onPress={() => navigation.navigate('Category')}>
              <Image
        ...
        <View style={styles.Maincaro}>
          <SwiperFlatList
            ...
            renderItem={({ item }) => (
              <ImageBackground key={banners.id}
                source={item.backgroundColorss}
        ...
        <View style={styles.offersSection}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.scrollView}>
            {offerItems.map((item, index) => (
              <TouchableOpacity key={index} style={styles.offerItem} onPress={() => navigation.navigate('Product_view_Screen')}>
                {/* Favorite Button */}
                <TouchableOpacity
                ...
                <Text style={styles.offerPrice}>{item.price} / {" "}
