...
import { View, Text, StyleSheet, SectionList, TouchableOpacity, SafeAreaView, Image, StatusBar } from 'react-native';
...
const styles = StyleSheet.create({
    ...
    iconContainer: { width: 40, height: 40, borderRadius: 20, marginRight: 16, justifyContent: 'center', alignItems:'center' },
